        ...
        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 bg-white divide-y space-y-1">
                <ul class="space-y-2 pb-2">
                    ...
                    <li>
                        <a href="{{ route('admin.users.view') }}" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 group {{ request()->routeIs('admin.users.*') ? 'bg-gray-100' : '' }}">
