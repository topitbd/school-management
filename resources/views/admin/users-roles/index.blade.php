                ...
                <div class="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 dark:divide-gray-600 mb-3 sm:mb-0">
                    <form class="lg:pr-3" action="{{ route('admin.users-roles.view') }}" method="GET">
                        ...
                        <div class="mt-1 relative lg:w-64 xl:w-96">
                            <input type="text" name="search" id="roles-search" value="{{ request('search') }}" class="bg-gray-50 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:placeholder-gray-400 text-gray-900 dark:text-white sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for roles">
                        </div>
                    </form>
                    <div class="flex space-x-1 pl-0 sm:pl-2 mt-3 sm:mt-0">
                        <select name="status" onchange="this.form.submit()" form="roles-status-form" class="bg-gray-50 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:placeholder-gray-400 text-gray-900 dark:text-white sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Slug</th>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($roles as $role)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500 dark:text-gray-400">{{ $role->slug }}</td>
