        ...
        <div class="mb-4">
            ...
            @include('admin.components.breadcrumb', [
                'menu' => [
                    ...
                    'text2' => translate('Categories'),
                    'url2' => route('admin.categories.view'),
                    'text3' => translate('Create Category'),
                ],
            ])

            <!----------------- Page title ----------------->
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">{{ translate('Create Category') }}</h1>
        </div>
