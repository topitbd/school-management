...
@section('content')
                ...
                <div class="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                    <form class="lg:pr-3" action="{{ route('admin.users.view') }}" method="GET">
                        ...
                        <div class="mt-1 relative lg:w-64 xl:w-96">
                            <input type="text" name="search" id="users-search" value="{{ request('search') }}" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for users">
                        </div>
                    </form>
                </div>
                ...
                <div class="shadow overflow-hidden">
                    <table class="table-fixed min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase">User</th>
                                <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase">Role</th>
                                <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase">Phone</th>
                                <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase">Country</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($users as $user)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">{{ $user->Role?->name ?? '-' }}</td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">{{ $user->phone ?? '-' }}</td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">{{ $user->country ?? '-' }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="p-4 text-center text-sm text-gray-500">No users found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    <div class="bg-white sm:flex items-center w-full sm:justify-between border-t border-gray-200 p-4">
        ...
        <div class="relative w-full max-w-md px-4 h-full md:h-auto">
            <div class="bg-white rounded-lg shadow relative">
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">Are you sure you want to delete <span id="delete-user-name" class="font-semibold text-gray-900"></span>?</h3>
